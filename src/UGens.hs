...
lpf :: UGen -> UGen -> UGen
lpf freq in_ =
  mkUGen Nothing [KR,AR] (Right [0]) "LPF" [in_,freq] Nothing 1 (Special 0) NoId

hpf :: UGen -> UGen -> UGen
hpf freq in_ =
  mkUGen Nothing [KR,AR] (Right [0]) "HPF" [in_,freq] Nothing 1 (Special 0) NoId

limiter :: UGen -> UGen -> UGen -> UGen
limiter level dur in_ =
  mkUGen Nothing [AR] (Right [0]) "Limiter" [in_,level,dur] Nothing 1 (Special 0) NoId

freeVerb :: UGen -> UGen -> UGen -> UGen -> UGen
freeVerb mix room damp in_ =
  mkUGen Nothing [AR] (Right [0]) "FreeVerb" [in_,mix,room,damp] Nothing 1 (Special 0) NoId
